...
class WithdrawBloc extends Bloc<WithdrawEvent, WithdrawState> {
  ...
  String? appId;
  String? firmId;
  WithdrawBloc() : super(WithdrawState()) {
  ...
  void _resetAllStates(ResetAllStates event, Emitter<WithdrawState> emit) {
    WithdrawState newState = state.copywith(
      selectedDate: '',
      bankTo: null,
  ...
  void _sendpayment(Sendpayment event, Emitter<WithdrawState> emit) {}

  void _showDatePicker(
      ShowDatePickerEvent event, Emitter<WithdrawState> emit) {}

  void _dateChanged(DateChanged event, Emitter<WithdrawState> emit) {
  ...
  void _fetchPatnerFirm(
      FetchPatnerFirm event, Emitter<WithdrawState> emit) async {
...
//----------------------------
  ...
  void _fetchBankTo(FetchBankTo event, Emitter<WithdrawState> emit) async {
...
//--------------------------------
  ...
  void _fetchBankFrom(FetchBankFrom event, Emitter<WithdrawState> emit) async {
    final prefs = await SharedPreferences.getInstance();
  ...
  void _selectPatnerFirm(SelectPatnerFirm event, Emitter<WithdrawState> emit) {
  ...
  void _selectBankFrom(SelectbankFrom event, Emitter<WithdrawState> emit) {
    emit(state.copywith(selectBankForm: event.bankID));
  }

  void _selectbankto(SelectBankTo event, Emitter<WithdrawState> emit) {
